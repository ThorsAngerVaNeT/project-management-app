...
import { SignInParams, TokenPayload, User, UserParams } from '@users/models/user.model';
...
export const userSignUp = createAction('[Auth] User Sign In', props<{ data: UserParams }>());
